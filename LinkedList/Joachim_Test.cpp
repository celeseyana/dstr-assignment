...
//	testcase1.loadWords("positive-words.txt", positiveListHead);
//	testcase1.loadWords("negative-words.txt", negativeListHead);
//
//	// load review csv file
//	ifstream file("tripadvisor_hotel_reviews1.csv");
//	if (!file.is_open())
//	{
